...
public interface VRPoseHistory {
     ...
     *
     * @param deviceNum The controller number, or -1 for the HMD, to get the net movement for.
     ...
     * @throws IllegalArgumentException Thrown when maxTicksBack is larger than {@value #MAX_TICKS_BACK} or less than 0.
     */
    Vec3 netMovement(int deviceNum, int maxTicksBack) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException Thrown when maxTicksBack is larger than {@value #MAX_TICKS_BACK} or less than 0.
     */
    Vec3 averageVelocity(int deviceNum, int maxTicksBack) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException Thrown when maxTicksBack is larger than {@value #MAX_TICKS_BACK} or less than 0.
     */
    default double averageSpeed(int deviceNum, int maxTicksBack) throws IllegalArgumentException {
        Vec3 averageVelocity = averageVelocity(deviceNum, maxTicksBack);
     ...
     * @throws IllegalArgumentException Thrown when maxTicksBack is larger than {@value #MAX_TICKS_BACK} or less than 0.
     */
    Vec3 averagePosition(int deviceNum, int maxTicksBack) throws IllegalArgumentException;
